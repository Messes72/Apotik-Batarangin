<script lang="ts">
	...
	import AlasanDeleteKustomer from '$lib/modals/delete/AlasanDeleteKustomer.svelte';
	import KonfirmDeleteKustomer from '$lib/modals/delete/KonfirmDeleteKustomer.svelte';
	...
	let active_button = $state('kustomer');
</script>
			...
			<div class="my-auto w-[1000px] rounded-xl bg-white drop-shadow-lg" on:click|stopPropagation>
				...
				<form class="my-6 px-8">
					<div class="mt-2 flex flex-col gap-2">
						...
						<TextArea
							id="catatan_kustomer"
							label="Catatan Kustomer"
							placeholder="Catatan Kustomer"
						/>
