<script lang="ts">
	...
	import AlasanDeleteReturnBarang from '$lib/modals/delete/AlasanDeleteReturnBarang.svelte';
	import KonfirmDeleteReturnBarang from '$lib/modals/delete/KonfirmDeleteReturnBarang.svelte';
...
<div class="mb-16">
	...
	<div class="flex w-full items-center justify-between gap-4 pb-8">
		<div class="flex h-10 w-[213px] items-center justify-center rounded-md bg-[#329B0D]">
			...
			>
				...
				<span class="ml-1 text-[16px]">Input Return Barang</span>
			</button>
		</div>
	...
	{#if isModalEditOpen}
		...
		>
			<div class="my-auto w-[1000px] rounded-xl bg-white drop-shadow-lg" on:click|stopPropagation>
				<div class="flex items-center justify-between p-8">
					<div class="font-montserrat text-[26px] text-[#515151]">Edit Data Return Barang</div>
