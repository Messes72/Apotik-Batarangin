<script lang="ts">
	...
	let active_button = $state('transaksi');
	let active_button_2 = $state('laporan');
	let active_button_3 = $state('riwayat');
	...
	<div class="mb-16">
		<div class="mb-7 flex h-10 w-[203px] items-center justify-center rounded-md bg-[#329B0D]">
			<button
				...
				on:click={() => goto('/transaksi/input_transaksi')}
			>
					...
					<div class="my-6 px-8">
						<div class="mt-2 flex flex-col gap-2">
							...
							<label for="alamat_kustomer" class="font-intersemi text-[14px] text-[#1E1E1E]"
								>jl.Sudriman No. 45, Surabaya</label
							>
							<input
								type="text"
