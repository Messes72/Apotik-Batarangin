...
{#if showLayout}
	<div class="flex min-h-screen">
		...
		{#if isSidebarOpen !== undefined}
			<!-- Sidebar -->
			<nav class="sidebar {isSidebarOpen ? 'sidebar-expanded' : 'sidebar-collapsed'} {isInitialized ? 'animated' : ''}">
				<div class="h-full">
					{#if isSidebarOpen}
					...
					{:else}
						...
						<div class="sidebar-content sidebar-content-enter">
							<div class="flex flex-col items-center py-4">
								<img src={gambar_logo} alt="gambar_logo" class="h-10 w-10 mb-6" />
								<div class="h-0.5 w-full bg-white mb-6"></div>

								<ul class="flex flex-col gap-3 items-center">
									<li class={$activeHover === 'dashboard' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/dashboard"
											class="p-2 rounded hover:bg-[#003349]"
											title="Dashboard"
										>
											<svg
												xmlns="http://www.w3.org/2000/svg"
									...
									<li class={$activeHover === 'product' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/product"
											class="p-2 rounded hover:bg-[#003349]"
											title="Product"
									...
									<li class={$activeHover === 'stock_opname' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/stock_opname"
											class="p-2 rounded hover:bg-[#003349]"
											title="Stock Opname"
									...
									<li class={$activeHover === 'pembelian_barang' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/pembelian_barang"
											class="p-2 rounded hover:bg-[#003349]"
									...
									<li class={$activeHover === 'penerimaan_barang' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/penerimaan_barang"
											class="p-2 rounded hover:bg-[#003349]"
									...
									<li class={$activeHover === 'request_barang' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/request_barang"
											class="p-2 rounded hover:bg-[#003349]"
									...
									<li class={$activeHover === 'return_barang' ? 'rounded-md bg-[#003349] w-12 flex justify-center' : 'w-12 flex justify-center'}>
										<a
											href="/return_barang"
											class="p-2 rounded hover:bg-[#003349]"
											title="Retur Barang"
							...
							<div class="absolute bottom-4 flex justify-center w-full">
								<button 
									onclick={handleLogout}
									disabled={isLoggingOut}
									class="p-2 rounded hover:bg-[#003349] disabled:opacity-75 disabled:cursor-not-allowed"
									title="Keluar"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
			...
			<!-- Main Content -->
			<div class="content-with-sidebar {isSidebarOpen ? 'expanded' : ''} {isInitialized ? 'animated' : ''} flex-1">
					...
					<div class="flex items-center gap-4">
						...
						>
							<div class="flex h-5 w-6 flex-col justify-between">
								<span
									class="hamburger-line {isSidebarOpen ? 'hamburger-line-1-open' : ''}"
								></span>
								<span
									class="hamburger-line {isSidebarOpen ? 'hamburger-line-2-open' : ''}"
								></span>
								<span
									class="hamburger-line {isSidebarOpen ? 'hamburger-line-3-open' : ''}"
								></span>
							</div>
						</button>
