...
<div class="mb-16">
		...
		>
			<div class="my-auto w-[1000px] rounded-xl bg-white drop-shadow-lg" on:click|stopPropagation>
				<div class="flex items-center justify-between p-8">
					<div class="font-montserrat text-[26px] text-[#515151]">Input Privilege Karyawan</div>
				...
				<form class="my-6 px-8" on:submit|preventDefault>
					<div class="mt-2 flex flex-col gap-2">
						<Input id="id_privilege" label="ID Privilege" type="text" placeholder="ID Privilege" />
						<Input id="privilege" label="Privilege" type="text" placeholder="Privilege" />
						<TextArea
	...
	{#if isModalEditOpen}
		...
		>
			<div class="my-auto w-[1000px] rounded-xl bg-white drop-shadow-lg" on:click|stopPropagation>
				<div class="flex items-center justify-between p-8">
					<div class="font-montserrat text-[26px] text-[#515151]">Edit Privilege Karyawan</div>
			...
			<div class="my-auto w-[1000px] rounded-xl bg-white drop-shadow-lg" on:click|stopPropagation>
				...
				<div class="my-6 px-8">
					<form class="mt-2 flex flex-col gap-2" on:submit|preventDefault>
						<Detail label="ID Privilege" value="Abraham Contoh Aja" />
						<Detail label="Privilege" value="Jl. Contoh Aja No. 123, Kota Contoh, 12345" />
						<Detail
							label="Catatan Privilege"
